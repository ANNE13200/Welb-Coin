...
const FarmCards: React.FC = () => {
  ...
  const welbIndex = farms.findIndex(
    ({ tokenSymbol }) => tokenSymbol === 'WELB',
  )

  const welbPrice =
    welbIndex >= 0 && stakedValue[welbIndex]
      ? stakedValue[welbIndex].tokenPriceInWeth
      : new BigNumber(0)

  const BLOCKS_PER_YEAR = new BigNumber(2336000)
  const WELB_PER_BLOCK = new BigNumber(100)
